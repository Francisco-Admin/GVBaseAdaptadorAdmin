...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gvDatos.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    DatadosParcelable datadosParcelable = new DatadosParcelable(dato.getNombre(),dato.getEdad(),dato.getSexo());
                    Intent intent = new Intent(MainActivity.this, DetallesActivity2.class);
                    intent.putExtra("Nombre",dato.getNombre());
                    intent.putExtra("DatosParcelable", datadosParcelable);
    ...
    public  void Graba(View v){
        ...
        if (conexion.Escribir(this,datos)){
            Toast.makeText(this, "Se escribieron corectamente", Toast.LENGTH_SHORT).show();
            Verifica();
        }else{
